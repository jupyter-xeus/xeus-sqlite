...
|--------------|-----------------|-----------------|-----------------|-----------------|-----------------|-----------|----------------|
|    main      | >=4.0.0, <5.0.0 | >=3.30.1, <4    | >=3.0.0, <4     | >=1.5.0         | >=3.12.0        | >= 0.1.3  | >= 0.1.1       |
|   0.10.x     | >=4.0.0, <5.0.0 | >=3.30.1, <4    | >=3.0.0, <4     | >=1.5.0         | >=3.12.0        | >= 0.1.3  | >= 0.1.1       |
|    0.9.x     | >=3.1.1, <4.0.0 | >=3.30.1, <4    | >=3.0.0, <4     | >=1.5.0         | >=3.12.0        | >= 0.1.3  | >= 0.1.1       |
